...
def plot_points_to_image(img, keypoints, projected_points, axis_points):
    ...
    if axis_points is not None:
        if np.isnan(axis_points).any() == False:
            ...
            cv2.line(img, (int(axis_points[0][0]), int(axis_points[0][1])), (int(axis_points[1][0]), int(axis_points[1][1])), (0, 0, 255), 30)
            cv2.line(img, (int(axis_points[0][0]), int(axis_points[0][1])), (int(axis_points[2][0]), int(axis_points[2][1])), (0, 255, 0), 30)
            cv2.line(img, (int(axis_points[0][0]), int(axis_points[0][1])), (int(axis_points[3][0]), int(axis_points[3][1])), (255, 0, 0), 30)
